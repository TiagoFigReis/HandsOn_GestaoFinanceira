...
namespace Infrastructure.Persistence.Repositories
{
    public class ReceitaRepository : IReceitaRepository
    {
        ...
        public async Task<Receitas> AddAsync(Receitas receita){
            var result = await _context.Receitas.AddAsync(receita);
            await _context.SaveChangesAsync();
            return result.Entity;
        }

        public async Task<Receitas> UpdateAsync(Receitas receita){
            var result = _context.Receitas.Update(receita);
            await _context.SaveChangesAsync();
            return result.Entity;
        }

        public async Task<Receitas> DeleteAsync(Receitas receita){
